...
*/
    ...
    15: [
      ...
      {
        "../../uswds-core/src/js/config": 33,
        "../../uswds-core/src/js/events": 34,
        "../../uswds-core/src/js/utils/behavior": 43,
    ...
    `;
        ...
        const handleDownFromYear = adjustYearSelectionScreen(
          (year) => year + 3
        );
        /**
        ...
        const handleLeftFromYear = adjustYearSelectionScreen(
          (year) => year - 1
        );
        /**
      ...
      },
      {
        "../../uswds-core/src/js/config": 33,
        "../../uswds-core/src/js/events": 34,
        "../../uswds-core/src/js/utils/active-element": 42,
        "../../uswds-core/src/js/utils/behavior": 43,
      ...
      function (require, module, exports) {
        ...
        const handleRangeStartUpdate = (el) => {
          ...
          if (updatedDate && !isDateInputInvalid(internalInputEl)) {
            ...
            rangeEndEl.dataset.minDate =
              dateRangePickerEl.dataset.minDate || "";
      ...
      function (require, module, exports) {
        ...
        function toggleModal(event) {
          ...
          const targetModal = safeActive
            ...
            : document.querySelector(".usa-modal-wrapper.is-visible"); // if there is no modal we return early
          ...
          body.style.paddingRight =
            body.style.paddingRight === TEMPORARY_PADDING
              ? INITIAL_PADDING
              : TEMPORARY_PADDING; // Handle the focus actions
    ...
    27: [
      function (require, module, exports) {
        ...
        const toggleSearch = (button, active) => {
          ...
          if (!form) {
            throw new Error(
              `No ${FORM} found for search toggle in ${CONTEXT}!`
            );
          }
  ...
  `;
    ...
    35: [
      ...
      {
        "../../../_usa-password/src/index": 15,
        "../../../usa-accordion/src/index": 16,
        "../../../usa-banner/src/index": 17,
        ...
        "../../../usa-input-prefix-suffix/src/index": 25,
        "../../../usa-modal/src/index": 26,
        "../../../usa-search/src/index": 27,
        "../../../usa-skipnav/src/index": 28,
        "../../../usa-table/src/index": 29,
        "../../../usa-time-picker/src/index": 30,
        "../../../usa-tooltip/src/index": 31,
        "../../../usa-validation/src/index": 32,
      },
    ],
    36: [
      function (require, module, exports) {
            ...
            if (target) {
              ...
              var fragment = document.createDocumentFragment(),
                viewBox =
                  ...
                  target.getAttribute("viewBox"); // conditionally set the viewBox on the svg
                  ...
                  xhr._embeds.splice(0).map(function (item) {
                    ...
                    target ||
                      (target = xhr._cachedTarget[item.id] =
                        cachedDocument.getElementById(item.id)), // embed the target into the svg
            ...
            polyfill =
              "polyfill" in opts
                ...
                : newerIEUA.test(navigator.userAgent) ||
                  ...
                  (edgeUA.test(navigator.userAgent) && inIframe); // create xhr requests object
    ...
    52: [
      ...
      { "./toggle-field-mask": 51, "resolve-id-refs": 14 },
    ],
    53: [
      function (require, module, exports) {
        "use strict";
