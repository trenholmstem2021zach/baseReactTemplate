      ...
      <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
       ...
       <HomeDropDownAuth/> 
        ...
        <div className="dropdown text-end">
          <a href="#a" className="d-block link-dark text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="./favicon.ico" alt="mdo" width="32" height="32" className="rounded-circle"/>
          </a>
          <ul className="dropdown-menu text-small">
            ...
            <li><a className="dropdown-item" href="#a"><AuthButton/></a></li>
          </ul>
        </div>
      </div>
    </div>
